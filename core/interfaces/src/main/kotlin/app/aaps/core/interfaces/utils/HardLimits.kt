...
interface HardLimits {
    companion object {
        ...
        val VERY_HARD_LIMIT_MIN_BG = doubleArrayOf(70.0, 180.0)
        val VERY_HARD_LIMIT_MAX_BG = doubleArrayOf(90.0, 200.0)
        val VERY_HARD_LIMIT_TARGET_BG = doubleArrayOf(70.0, 200.0)

        // Very Hard Limits Ranges for Temp Targets
        val VERY_HARD_LIMIT_TEMP_MIN_BG = intArrayOf(62, 180)
        val VERY_HARD_LIMIT_TEMP_MAX_BG = intArrayOf(62, 270)
        val VERY_HARD_LIMIT_TEMP_TARGET_BG = intArrayOf(62, 200)
